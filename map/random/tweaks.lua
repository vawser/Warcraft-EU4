...
RandomWorld = {
	...
	options = {
		width				= 2156,
		height				= 2048,
		overlapping_sea_province_search_width = 2400, -- Any sea province that overlaps with the randomized area needs to be removed from the provincemap, overlapping_sea_province_search_width is the rightmost edge of the area of the provincemap that will be searched for these provinces
