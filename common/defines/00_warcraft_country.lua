...
NDefines.NCountry.FEMALE_ADVISOR_CHANCE = 0.5
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_1 = 1
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_2 = 2
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_3 = 3
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_4 = 4
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_5 = 5
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_6 = 6
NDefines.NCountry.LIBERTY_DESIRE_RELATIVE_POWER = 25 -- Reduce liberty desire increase for relative power
...
-- Ruler death handled via event
-- Allows for special handling with the differing racial lifespans
