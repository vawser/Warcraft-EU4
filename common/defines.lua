...
NCountry = {
	...
	LAGGINGTECH_CORRUPTION = 0.0,					-- Corruption increase/year. Multiplied by (highest - lowest) tech level
...
NAI = {
	...
	PEACE_TIME_MAX_MONTHS = 0, -- Max months applied to time factor in a war
